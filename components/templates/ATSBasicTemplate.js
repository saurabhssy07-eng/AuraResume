export default function ATSBasicTemplate({ data }) {
  const {
    personalInfo = {},
    experience = [],
    education = [],
      ...
      case 'personal':
        ...
        return (
          <div key="personal" style={{ marginBottom: sectionSpacing }}>
            <h2 style={{ fontSize: '1.1em', fontWeight: 'bold', borderBottom: themeColor !== '#3b82f6' ? `2px solid ${themeColor}` : 'none', paddingBottom: '3px', margin: '0 0 8px 0', textTransform: 'none', color: '#1f2937', letterSpacing: '0.03em' }}>
      ...
      case 'experience':
        ...
        return (
          <div key="experience" style={{ marginBottom: sectionSpacing }}>
            <h2 style={{ fontSize: '1.1em', fontWeight: 'bold', borderBottom: themeColor !== '#3b82f6' ? `2px solid ${themeColor}` : 'none', paddingBottom: '3px', margin: '0 0 12px 0', textTransform: 'none', color: '#1f2937', letterSpacing: '0.03em' }}>
              Work Experience
            </h2>
            <div style={{
