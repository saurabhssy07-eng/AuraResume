      ...
      case 'personal':
        ...
        return (
          <div key="personal" style={{ marginBottom: sectionSpacing }}>
            <h2 style={{ fontSize: '1.1em', fontWeight: 'bold', borderBottom: '1px solid #000', borderTop: '1px solid #000', paddingTop: '3px', paddingBottom: '3px', margin: '0 0 8px 0', textTransform: 'uppercase', color: '#1f2937', letterSpacing: '0.03em' }}>
      ...
      case 'experience':
        ...
        return (
          <div key="experience" style={{ marginBottom: sectionSpacing }}>
            <h2 style={{ fontSize: '1.1em', fontWeight: 'bold', borderBottom: '1px solid #000', borderTop: '1px solid #000', paddingTop: '3px', paddingBottom: '3px', margin: '0 0 12px 0', textTransform: 'uppercase', color: '#1f2937', letterSpacing: '0.03em' }}>
              Work Experience
            </h2>
            <div style={{
  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: 'center', marginBottom: sectionSpacing }}>
        <h1 style={{ fontSize: '2em', fontWeight: 'bold', margin: '0 0 6px 0', color: themeColor !== '#3b82f6' ? themeColor : '#000', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
