export default function StanfordTemplate({ data }) {
  const {
    personalInfo = {},
    experience = [],
    education = [],
      ...
      case 'personal':
        ...
        return (
          <div key="personal" style={{ marginBottom: sectionSpacing }}>
            <h2 style={{ fontSize: '1.1em', fontWeight: 'bold', borderBottom: themeColor !== '#3b82f6' ? `2px solid ${themeColor}` : '2px solid #8C1515', paddingBottom: '3px', margin: '0 0 8px 0', textTransform: 'uppercase', color: '#1f2937', letterSpacing: '0.03em' }}>
      ...
      case 'experience':
        ...
        return (
          <div key="experience" style={{ marginBottom: sectionSpacing }}>
            <h2 style={{ fontSize: '1.1em', fontWeight: 'bold', borderBottom: themeColor !== '#3b82f6' ? `2px solid ${themeColor}` : '2px solid #8C1515', paddingBottom: '3px', margin: '0 0 12px 0', textTransform: 'uppercase', color: '#1f2937', letterSpacing: '0.03em' }}>
              Work Experience
            </h2>
            <div style={{
              ...
              {projects.map((proj, i) => (
                <div key={i} style={{ marginBottom: projectsColumns === '2' ? '0' : (i < projects.length - 1 ? itemSpacing : '0') }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', fontWeight: 'bold', color: '#1f2937', fontSize: '0.95em' }}>
                    <span>
                      {proj.name}
                      {proj.link && <a href={proj.link} style={{ color: themeColor !== '#3b82f6' ? themeColor : '#8C1515', fontSize: '0.85em', marginLeft: '8px', fontWeight: 'normal' }} target="_blank" rel="noreferrer">Link</a>}
                    </span>
            ...
            <ul style={{ margin: 0, paddingLeft: '16px', color: '#4b5563', fontSize: '0.9em' }}>
              {certifications.map((cert, i) => (
                <li key={i} style={{ marginBottom: '4px' }}>
                  ...
                  {cert.link && <a href={cert.link} style={{ color: themeColor !== '#3b82f6' ? themeColor : '#8C1515', fontSize: '0.85em', marginLeft: '8px', fontWeight: 'normal', textDecoration: 'underline' }} target="_blank" rel="noreferrer">Verify</a>}
                </li>
              ))}
            </ul>
          </div>
  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: 'left', marginBottom: sectionSpacing }}>
        <h1 style={{ fontSize: '2em', fontWeight: 'bold', margin: '0 0 6px 0', color: themeColor !== '#3b82f6' ? themeColor : '#8C1515', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: '10px', fontSize: '0.85em', color: '#4b5563' }}>
          ...
          {personalInfo.website && <span>• <a href={personalInfo.website} style={{ color: themeColor !== '#3b82f6' ? themeColor : '#8C1515' }} target="_blank" rel="noreferrer">{personalInfo.website}</a></span>}
          {personalInfo.linkedin && <span>• <a href={personalInfo.linkedin} style={{ color: themeColor !== '#3b82f6' ? themeColor : '#8C1515' }} target="_blank" rel="noreferrer">LinkedIn</a></span>}
          {personalInfo.github && <span>• <a href={personalInfo.github} style={{ color: themeColor !== '#3b82f6' ? themeColor : '#8C1515' }} target="_blank" rel="noreferrer">GitHub</a></span>}
        </div>
      </div>
